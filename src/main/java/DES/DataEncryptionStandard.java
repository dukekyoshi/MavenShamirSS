...
public class DataEncryptionStandard {
    ...
    protected String[] round(String left, String right, String rndKey) {
        String Ln = right;
    ...
    protected String feistelCipher(String right, String rndKey) {
        String res = "";
    ...
    protected String initialPermutation(String msgblock) {
        String res = permute(msgblock, IP);
        return res;
    }

    protected void createSubKey() {
    ...
    protected String leftShift(String text, int bit) {
        String res = "";
    ...
    protected String permute(String text, int[] permutationBox) {
        String res = "";
